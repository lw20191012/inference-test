...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="resnet50 model infernce with ort")
    parser.add_argument("--batch-size", "-b", type=int, help="batch size of each inference")
    ...
    # print(args.execution_provider)
    # print(type(args.execution_provider))
    ...
    # 加载模型
    onnx_model_path = prepareModel(device, args.batch_size)
